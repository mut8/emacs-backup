...
** Local Org-mode org-capture settings
   Set up a notes file and easy capture arrangement. 

#+source: org-capture
#+begin_src emacs-lisp tangle:no
  (setq org-default-notes-file (concat org-directory "notes.org"))
  (define-key global-map "\C-cp" 'org-capture) ;; p for Pinboard
...
** PeepOpen Application
   An alternative to C-x C-f, native to Mac OS X, sold by PeepCode. See http://peepcode.com/products/peepopen. 
...
#+begin_src emacs-lisp tangle:no
  ...
  ;; use this to open files in the existing frame:
  (setq ns-pop-up-frames nil) 
  
  ;; force C-c t to peepopen
