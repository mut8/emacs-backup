...
#+begin_src emacs-lisp
   ...
   \\input{vc} % REMOVE THIS LINE IF YOU DO NOT USE VC + GIT
    ...
    \\usepackage{memoir-article-styles} % Available at https://github.com/kjhealy/latex-custom-kjh
    \\usepackage{fontspec,xunicode}
    %%% Change or remove the following three lines if you do not have these fonts installed
    \\setsansfont[Mapping=tex-text,BoldFont={DINPro-Medium},ItalicFont={DIN-RegularItalic}]{DINPro-Medium}  
    \\setmonofont[Mapping=tex-text,Scale=MatchLowercase]{PragmataPro} 
    \\setromanfont[Mapping=tex-text,Numbers=OldStyle]{Minion Pro} 
    \\usepackage[american]{babel}
    \\usepackage[babel]{csquotes}
    \\usepackage[style=authoryear-comp-ajs, 
                 abbreviate=true]{biblatex} % Available at https://github.com/kjhealy/latex-custom-kjh
    \\bibliography{socbib} % Available at https://github.com/kjhealy/socbibs
    \\usepackage{listings}
    \\usepackage{listings-sweave-xelatex} % Available at https://github.com/kjhealy/latex-custom-kjh
    \\usepackage[svgnames]{xcolor}
    \\usepackage{soul}
    \\usepackage[xetex, colorlinks=true, urlcolor=FireBrick,
