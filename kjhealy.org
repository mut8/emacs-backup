...
#+srcname: org-babel
#+begin_src emacs-lisp 
  (setq org-src-fontify-natively t) ;; Turn on font coloring of src snippets in org files
...
** Minimal mode
   A nice clutter-free appearance with a reduced-size modeline. 
#+source: minimal-mode
#+begin_src emacs-lisp
  (require 'minimal)
