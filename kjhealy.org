...
#+begin_src emacs-lisp
  ...
  ;; require maxframe package to conveniently maxmimize the window with M-x MFA
  ;;(require 'maxframe)
...
*** icicles
    Replacement for/alternative to ido-mode.
#+srcname: icicles
...
*** Word-count
    ...
    up typing inside the text that's already there. 
